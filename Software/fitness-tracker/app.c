...
#include "src/ble.h"
#include "src/scheduler_max32664.h"
#include "src/scheduler_bmi270.h"
...
#elif (LOWEST_ENERGY_MODE == EM1 || LOWEST_ENERGY_MODE == EM2 || LOWEST_ENERGY_MODE == EM3)
 ...
 * powerInit()
 * ------------------------------------------------------------------------------------
 * @Purpose : This function initializes power state based on energy mode selected
 * @Param   : None
 * @Return  : None
 *-------------------------------------------------------------------------------------*/
void powerInit(void)
