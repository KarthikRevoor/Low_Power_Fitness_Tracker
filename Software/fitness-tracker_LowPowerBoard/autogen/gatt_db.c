...
{
  0x89, 0xe8, 0x09, 0x95, 0x60, 0x65, 0x0c, 0xb0, 0x3e, 0x45, 0xd5, 0xfd, 0xd2, 0x81, 0x07, 0xfe, 
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_22) = {
  .len = 16,
  .data = { 0x29, 0xe0, 0xee, 0x72, 0x25, 0x16, 0x65, 0x93, 0x63, 0x43, 0x30, 0x1e, 0x38, 0xf8, 0x9d, 0x95, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 15,
  .data = { 0x4c, 0x6f, 0x77, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x72, 0x73, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x18, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x22, .char_uuid = 0x8000 } },
  { .handle = 0x19, .uuid = 0x8000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_24 },
  { .handle = 0x1a, .uuid = 0x000b, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x02, .clientconfig_index = 0x02 } },
};
